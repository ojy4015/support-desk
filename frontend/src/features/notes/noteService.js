...
// create new ticket note , protected route
const createNote = async (noteText, ticketId, token) => {
  // console.log('noteText, ticketId, token --', noteText, ticketId, token);
  const config = {
    headers: {
...
// get ticket notes for a ticket for logged in user , protected route
