...
// @desc   get notes for a ticket id's ticket for logged in user
// @route  GET http://localhost:5000/api/tickets/:ticketId/notes
// @access Private
const getNotes = asyncHandler(async (req, res) => {
  ...
  // get notes for 해당 ticket of logged in user
...
// @route  POST http://localhost:5000/api/tickets/ticketId/notes
// @access Private
